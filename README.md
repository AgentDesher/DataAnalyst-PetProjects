...
|--------------------------|----------|----------|----------|
| [Проект №1](https://github.com/AgentDesher/YandexPracticum-DataAnalyst-Projects/tree/main/real-estate-analytics "Код проекта на GitHub")  | Анализ рынка недвижимости Санкт-Петербурга и Ленинградской оболасти. [Dashboard](https://datalens.yandex/quoa8ncrof3ib) | SQL, Datalens| — |
...
| [Проект №5](https://github.com/AgentDesher/DataAnalyst-PetProjects/tree/main/analyst_vacancies_hh_ru) | Анализ вакансий для аналитиков данных на HH.ru. [Dashboard](https://datalens.yandex/736dbp9afnq0s) | SQL, DataLens | — |
| [Проект №6](https://github.com/AgentDesher/DataAnalyst-PetProjects/tree/main/app-ab-test) | Разработка и анализ результатов A/B-тестирования для приложения с "бесконечной" лентой. | Python | Pandas, Matplotlib,<br>Math, SciPy,<br>NormalIndPower,<br>Proportions_ztest |
